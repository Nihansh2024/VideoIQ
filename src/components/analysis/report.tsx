...
export function Report() {
  ...
  // Pro state comes from the API response itself (authoritative — backend re-checked).
  const isPro = r.isPro === true || r.plan === "pro";
  const showWatermark = r.watermark === true && !isPro;
    ...
    <div className="min-h-screen pt-20 pb-16 relative">
      {showWatermark && (
        <div className="pointer-events-none fixed inset-0 z-[1] flex items-center justify-center overflow-hidden">
          <div
            className="text-[6rem] sm:text-[10rem] font-black text-foreground/[0.025] select-none rotate-[-30deg] whitespace-nowrap"
            aria-hidden
          >
            Generated by VideoIQ Free
          </div>
        </div>
      )}
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Section 5: Content Suggestions (Pro-only) */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-bold flex items-center gap-2">
              ...
              Content Suggestions
              {!isPro && (
                <Badge className="ml-2 bg-brand/10 text-brand border-brand/20 text-[10px] gap-1 px-2 py-0.5">
              ...
              <CardContent className="p-6">
                <div className="flex flex-col sm:flex-row items-center gap-4">
                  ...
                  <div className="text-center sm:text-left flex-1">
                    <h3 className="font-bold mb-1">Unlock Content Suggestions, SEO Tips & Competitor Analysis</h3>
                    <p className="text-sm text-muted-foreground">
                      Upgrade to Pro to get AI-generated title ideas, keyword suggestions, SEO improvements, and description tips for every video you analyze.
                    </p>
                  </div>
        ...
        {/* Pro Features Promo (only shown for Free users) */}
        {!isPro && (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            ...
            <Card className="border-brand/20 bg-gradient-to-br from-brand/5 to-brand-purple/5 mb-8">
              <CardContent className="p-6">
                <div className="flex flex-col sm:flex-row items-center gap-4">
                  ...
                  <div className="text-center sm:text-left flex-1">
                    <h3 className="font-bold mb-1">Unlock PDF Export & Priority Processing</h3>
                    <p className="text-sm text-muted-foreground">
                      Upgrade to Pro to export reports as PDF, analyze competitor channels, and get advanced AI insights with priority processing.
                    </p>
                  </div>
                  <Button onClick={handleUpgrade} className="bg-gradient-to-r from-brand to-brand-purple text-white hover:opacity-90 flex-shrink-0">
        ...
        >
          {isPro ? (
            ...
            <Button
              variant="outline"
              className="gap-2 flex-1 relative overflow-hidden"
              onClick={handleUpgrade}
            >
              <Lock className="w-4 h-4" />
              Download Report
              <Badge className="ml-1 bg-brand/10 text-brand border-brand/20 text-[10px] px-1.5 py-0">PRO</Badge>
            </Button>
          )}
          <Button
            variant="outline"
